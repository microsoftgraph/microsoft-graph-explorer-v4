...
export const SCOPES_FETCH_SUCCESS = 'SCOPES_FETCH_SUCCESS';
export const SCOPES_FETCH_ERROR = 'SCOPES_FETCH_ERROR';
export const SCOPES_FETCH_PENDING = 'SCOPES_FETCH_PENDING';
