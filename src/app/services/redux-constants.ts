...
export const APPLICATION_PERMISSIONS_SUCCESS = 'APPLICATION_PERMISSIONS_SUCCESS';
export const APPLICATION_PERMISSIONS_FAILURE = 'APPLICATION_PERMISSIONS_FAILURE';
export const DELEGATED_PERMISSIONS_SUCCESS = 'DELEGATED_PERMISSIONS_SUCCESS';
export const DELEGATED_PERMISSIONS_FAILED = 'DELEGATED_PERMISSIONS_FAILED';