...
describe('lookupTemplate', () => {
  it('returns Profile template for /me', () => {
    const result = lookupTemplate({
      sampleUrl: 'https://graph.microsoft.com/v1.0/me', selectedVerb: 'GET', sampleHeaders: []
    } as any);
  ...
  it('returns Messages template for /me/messages', () => {
    const result = lookupTemplate({
      sampleUrl: 'https://graph.microsoft.com/v1.0/me/messages', selectedVerb: 'GET', sampleHeaders: []
    } as any);
  ...
  it('returns Groups template for /groups', () => {
    const result = lookupTemplate({
      sampleUrl: 'https://graph.microsoft.com/v1.0/groups', selectedVerb: 'GET', sampleHeaders: []
    } as any);
  ...
  it('returns Users template for /users', () => {
    const result = lookupTemplate({
      sampleUrl: 'https://graph.microsoft.com/v1.0/users', selectedVerb: 'GET', sampleHeaders: []
    } as any);
  ...
  it('returns Files template for /me/drive/root/children', () => {
    const result = lookupTemplate({
      sampleUrl: 'https://graph.microsoft.com/v1.0/me/drive/root/children', selectedVerb: 'GET', sampleHeaders: []
    } as any);
  ...
  it('returns undefined for unmapped URL', () => {
    const result = lookupTemplate({
      sampleUrl: 'https://graph.microsoft.com/v1.0/subscriptions', selectedVerb: 'GET', sampleHeaders: []
    } as any);
