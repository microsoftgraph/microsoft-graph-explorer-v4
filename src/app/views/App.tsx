...
import {
  FluentProvider, makeStyles,
  teamsHighContrastTheme, Theme, webDarkTheme, webLightTheme
...
const useAppStyles = makeStyles({
  ...
  requestArea: {
    gridArea: 'request-area'
  },
  responseArea: {
    gridArea: 'response-area'
  },
  footer: {
    gridArea: 'footer'
  }
...
class App extends Component<IAppProps, IAppState, ComponentProps> {
