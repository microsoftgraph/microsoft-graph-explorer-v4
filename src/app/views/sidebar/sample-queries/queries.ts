import { ISampleQueries } from "../../../../types/query-runner";


export const queries: ISampleQueries = {
    sampleQueries: [
        {
    ...
    teamsAppSampleQueries: [
        ...
        {
            "id": "202c5ea9-433f-43d9-8246-334d294f978b",
            "category": "Microsoft Teams (beta)",
            "method": "PATCH",
            "humanName": "update channel",
            "requestUrl": "/beta/teams/{team-id}/channels/{channel-id}",
            "docLink": "https://docs.microsoft.com/en-us/graph/api/channel-patch?view=graph-rest-beta",
            "headers": [
                {
                    "name": "Content-type",
                    "value": "application/json"
        ...
        },
        {
            ...
            "category": "Microsoft Teams (beta)",
            "method": "GET",
            "humanName": "resource-specific permissions in chat",
            "requestUrl": "/beta/chats/{chat-id}/permissionGrants",
            "docLink": "https://docs.microsoft.com/en-us/graph/api/chat-list-permissiongrants?view=graph-rest-beta&tabs=http",
            "tip": "This query requires a chat id. To find the chat ids, you can switch to user (delegated permissions) mode and run: GET https://graph.microsoft.com/beta/me/chats/",
            "skipTest": false
        },
        {
        ...
        {
            "id": "eb9b7f19-491b-423f-a821-9975615022a4",
            "category": "Microsoft Teams (beta)",
            "method": "GET",
            "humanName": "chat info",
            "requestUrl": "/beta/chats/{chat-id}",
            "docLink": "https://docs.microsoft.com/en-us/graph/api/chat-get?view=graph-rest-beta",
            "tip": "This query requires a chat id. To find a list of chats and their corresponding ids, run GET https://graph.microsoft.com/beta/me/chats/",
            "skipTest": false
        },
        {
            "id": "acc823bc-f501-4cce-9441-06cbfa2f2884",
            "category": "Microsoft Teams (beta)",
            "method": "GET",
            "humanName": "chat messages",
            "requestUrl": "/beta/chats/{chat-id}/messages",
            "docLink": "https://docs.microsoft.com/en-us/graph/api/chat-get?view=graph-rest-beta",
            "tip": "This query requires a chat id. To find a list of chats and their corresponding ids, run GET https://graph.microsoft.com/beta/me/chats/",
            "skipTest": false
        }
